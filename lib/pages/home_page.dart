...
class _HomePageState extends State<HomePage> {
    ...
    Widget build(BuildContext context) {
        ...
        // Get reported padding
        topPadding = MediaQuery.of(context).padding.top;

        // If device reports 0 (like Vivo Y19), fallback to 24 (typical status bar height)
        if (topPadding == 0) {
            topPadding = 24; // checks if padding.top is 0, and if yes, forces 24 px manually (because most Android status bars are ~24 px)
        }
