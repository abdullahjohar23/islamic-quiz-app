final List<List<String>> questionAnswer = [
    ...
    ["Name an Islamic figure starting with 'A'", "Adam (As) / Abu Bakr (Ra) / Ali (Ra)"],
    ["Name an Islamic figure starting with 'B'", "Bilal (RA)"],
    ["Name an Islamic figure starting with 'D'", "Dawud (As) / Dhul-Qarnayn"],
    ["Name an Islamic figure starting with 'F'", "Fatimah (Ra) / Fir'aun"],
    ["Name an Islamic figure starting with 'H'", "Hamzah (Ra)"],
    ["Name an Islamic figure starting with 'I'", "Ibrahim (As)"],
    ["Name an Islamic figure starting with 'J'", "Jibrael (As)"],
    ["Name an Islamic figure starting with 'K'", "Khadijah (Ra)"],
    ["Name an Islamic figure starting with 'L'", "Luqman (As)"],
    ["Name an Islamic figure starting with 'M'", "Muhammad (ﷺ)"],
    ["Name an Islamic figure starting with 'N'", "Nuh (As)"],
    ["Name an Islamic figure starting with 'Q'", "Qarun"],
    ["Name an Islamic figure starting with 'R'", "Ruqayyah (Ra)"],
    ["Name an Islamic figure starting with 'S'", "Sulaiman (As) / Salman al-Farsi (Ra)"],
    ["Name an Islamic figure starting with 'T'", "Talhah ibn Ubaidullah (Ra)"],
    ["Name an Islamic figure starting with 'U'", "Umar ibn Al-Khattab (Ra) / Uthman ibn Affan (Ra)"],
    ["Name an Islamic figure starting with 'W'", "Waraqah ibn Nawfal"],
    ["Name an Islamic figure starting with 'Y'", "Yusuf (As) / Yunus (as) / Yahya (As)"],
    ["Name an Islamic figure starting with 'Z'", "Zakariya (As) / Zayd ibn Harithah (Ra)"],
];
